...
#define nrn_init _nrn_init__ProbUDFsyn2_lark
#define _nrn_initial _nrn_initial__ProbUDFsyn2_lark
#define nrn_cur _nrn_cur__ProbUDFsyn2_lark
#define _nrn_current _nrn_current__ProbUDFsyn2_lark
#define nrn_jacob _nrn_jacob__ProbUDFsyn2_lark
#define nrn_state _nrn_state__ProbUDFsyn2_lark
#define _net_receive _net_receive__ProbUDFsyn2_lark 
#define setRNG setRNG__ProbUDFsyn2_lark 
#define state state__ProbUDFsyn2_lark 
...
#define erand erand_ProbUDFsyn2_lark
 extern double erand( );
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 ProbUDFsyn2_lark /Users/hadasmanor/Documents/GitHubProjects/OOP_SimulationGUI/x86_64/ProbUDFsyn2_lark.mod\n");
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 84 in file ProbUDFsyn2_lark.mod:\n        SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/hadasmanor/Documents/GitHubProjects/OOP_SimulationGUI/mods/ProbUDFsyn2_lark.mod";
static const char* nmodl_file_text = 
