...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 cad /Users/hadasmanor/Documents/GitHubProjects/OOP_SimulationGUI/x86_64/cad.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {int _reset = 0; {
   ...
   Dca = drive_channel / 18.0 + ( cainf - ca ) / tauca ;
   cai = ca ;
   }
 return _reset;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/hadasmanor/Documents/GitHubProjects/OOP_SimulationGUI/mods/cad.mod";
static const char* nmodl_file_text = 
