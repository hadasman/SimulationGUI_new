...
#define nrn_init _nrn_init__cadiffus
#define _nrn_initial _nrn_initial__cadiffus
#define nrn_cur _nrn_cur__cadiffus
#define _nrn_current _nrn_current__cadiffus
#define nrn_jacob _nrn_jacob__cadiffus
#define nrn_state _nrn_state__cadiffus
#define _net_receive _net_receive__cadiffus 
#define factors factors__cadiffus 
#define state state__cadiffus 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_cadiffus", _hoc_setdata,
 "factors_cadiffus", _hoc_factors,
 0, 0
};
 /* declare global and static user variables */
#define DCa DCa_cadiffus
 double DCa = 0.23;
#define vrat vrat_cadiffus
 double vrat[4];
 ...
 "DCa_cadiffus", &DCa_cadiffus,
 0,0
};
 static DoubVec hoc_vdoub[] = {
 "vrat_cadiffus", vrat_cadiffus, 4,
 0,0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "diam");
 	...
 	ivoc_help("help ?1 cadiffus /Users/hadasmanor/Documents/GitHubProjects/OOP_SimulationGUI/x86_64/cadiffus.mod\n");
...
_MATELM1(_i + 0, _i + 0) *= ( diam * diam * vrat [ ((int) _i ) ]);  } }
 ...
 f_flux = b_flux = 0.;
 _RHS1( 0 +  0) += (b_flux =   ( - ica * PI * diam / ( 2.0 * FARADAY ) ) );
 /*FLUX*/
  {int  _li ;for ( _li = 0 ; _li <= 4 - 2 ; _li ++ ) {
...
static double _difcoef1(int _i, double* _p, Datum* _ppvar, double* _pdvol, double* _pdfcdc, Datum* _thread, _NrnThread* _nt) {
 ...
 static void _difusfunc(ldifusfunc2_t _f, _NrnThread* _nt) {int _i;
  for (_i=0; _i < 4; ++_i) (*_f)(_mechtype, _difcoef1, &_difspace1, _i,  0, 7 , _nt);
 }
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 52 in file cadiffus.mod:\n	SOLVE state METHOD sparse\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 4; ++_i) {
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/hadasmanor/Documents/GitHubProjects/OOP_SimulationGUI/mods/cadiffus.mod";
static const char* nmodl_file_text = 
