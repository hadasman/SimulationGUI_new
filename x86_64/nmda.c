...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 nmda /Users/hadasmanor/Documents/GitHubProjects/OOP_SimulationGUI/x86_64/nmda.mod\n");
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 117 in file nmda.mod:\n	\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/hadasmanor/Documents/GitHubProjects/OOP_SimulationGUI/mods/nmda.mod";
static const char* nmodl_file_text = 
