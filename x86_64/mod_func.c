...
extern void _ProbUDFsyn2_lark_reg(void);
extern void _SK_E2_reg(void);
extern void _SKv3_1_reg(void);
extern void _SynExp5NMDA_reg(void);
extern void _ampa_reg(void);
extern void _cad_reg(void);
extern void _cadiffus_reg(void);
extern void _canmda_reg(void);
...
void modl_reg(){
  if (!nrn_nobanner_) if (nrnmpi_myid < 1) {
    ...
    fprintf(stderr," mods/ProbUDFsyn2_lark.mod");
    fprintf(stderr," mods/SK_E2.mod");
    fprintf(stderr," mods/SKv3_1.mod");
    fprintf(stderr," mods/SynExp5NMDA.mod");
    fprintf(stderr," mods/ampa.mod");
    fprintf(stderr," mods/cad.mod");
    fprintf(stderr," mods/cadiffus.mod");
    fprintf(stderr," mods/canmda.mod");
    fprintf(stderr," mods/car.mod");
